...
function polestar_woocommerce_scripts() {
	...
	wp_enqueue_script( 'polestar-woocommerce-script', get_template_directory_uri() . '/woocommerce/js/jquery.woocommerce'  . PURO_THEME_JS_PREFIX . '.js', array( 'jquery', 'wc-add-to-cart-variation' ), PURO_THEME_VERSION, true );
